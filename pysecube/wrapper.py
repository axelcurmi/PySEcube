...
class Wrapper(object):
    ...
    def crypt(self, algorithm: int, mode: int, keyID: int, data_in: bytes,
                iv: bytes = None) -> bytes:
        ...
        if self._lib.Crypt(self._l1, algorithm, mode, keyID, buffer_len,
